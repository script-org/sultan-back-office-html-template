$(document).ready(function () {
  ...
  var program_name = $('#ghost .title-item-name').text() == '' ? 'Gold Coins' : $('#ghost .title-item-name').text();
  ...
  $('footer .save').click(function () {
    notification(program_name + ' updated successfully.');
  ...
  $('footer .delete').click(function () {
    $('#delete-program-name').text($('#program-name').val());
  });
