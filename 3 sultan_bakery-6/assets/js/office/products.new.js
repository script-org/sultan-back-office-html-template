$(document).ready(function () {
  ...
  function product_table_CSS_hide_show(targett, Show) {
    if (Show) {
      ...
      targett.eq(4).addClass('hide');
      targett.eq(5).removeClass('hide');
    }
    else {
      targett.eq(3).removeClass('hide');
      targett.eq(4).removeClass('hide');
      targett.eq(5).addClass('hide');
    }
  }
      ...
      html += '</div> \
        <div class="col-md-2 hide" > \
                                <div class="input-group"> \
                                  ...
                                  <input type="number" value="10000" class="number-format form-control" \
  ...
  $('footer .save').click(function () {
    if (Math.random() > 0.2) {
      $('#ghost .success-title-message').text('New product added successfully');
  ...
  // $('#div-supplier-name').on('click', '#select2-supplier_name-container', function () {
  //   $('#select2-supplier_name-results').prepend('<li class="select2-results__option select2-results__option--highlighted" id="select2-supplier_name-result-bbym-new" role="treeitem" aria-selected="false">\
  //                           <button class="btn btn-raised">Add new supplier</button></li>');
  // });

  // $(document).on('click', '#select2-supplier_name-result-bbym-new>button', function () {
  //   $('#supplier-add-modal').modal('show');
  //   $(this).val('');
  // });
  ...
  $('#div-category-name').on('click', '#select2-category_name-container', function () {
    $('#select2-category_name-results').prepend('<li class="select2-results__option select2-results__option--highlighted" id="select2-category_name-result-bbym-new" role="treeitem" aria-selected="false">\
                            <button class="btn btn-raised">Add new category</button></li>');
  });
